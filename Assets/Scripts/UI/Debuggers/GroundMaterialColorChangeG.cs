...
public class GroundMaterialColorChangeG : MonoBehaviour
{
    ...
    public void ValueChangeCheck()
    {
        ...
        {
            GroundMat.material.color = new Color(GroundMat.material.color.r, mainSlider.value, GroundMat.material.color.b);
        }
